    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formEditarCategoria">
          ...
          <div class="mb-3">
            <label for="editDescripcionCategoria" class="form-label">Descripción (opcional)</label>
            <textarea class="form-control" id="editDescripcionCategoria" name="descripcion" rows="3"></textarea>
          </div>
        </form>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
        <button type="submit" form="formEditarCategoria" class="btn btn-primary">Actualizar categoría</button>
      </div>
        ...
        $( function (){
            ...
            $(document).ready(function () {
                $('#formEditarCategoria').on('submit', function (e) {
                    e.preventDefault();
                    app.updateCategory(); // ✅ Llama la función dentro de app.js
                });
            });
