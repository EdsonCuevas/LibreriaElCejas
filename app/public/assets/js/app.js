        ...
        return `
            <div class="w-100 p-4 shadow rounded bg-body">
                ...
                ${ post[0].body }
                 ...
                 `<a href="#" class="btn btn-link btn-sm text-decoration-none disabled"
                    onclick="app.toggleLike(${ post[0].id },userId)">
                    <i class="bi bi-hand-thumbs-up" id="iLikeHand"></i> 
                    <span id="likes" class="fw-bold"> ${ post[1].tt } <!-- Te gusta --></span>
                 </a>
